...
\begin{quotation}
    Čím více \textbf{druhů}, \textit{řezů}, {\tiny velikostí,} {\color{green}barev} písma a {\color{blue}\textsc{jiných efektů}} \underline{použijeme}, {\color{red}tím profesionálněji} bude {\fontfamily{pzc}\selectfont dokument} vypadat. Čtenář tím bude \textbf{\Huge vždy nadšen!}
\end{quotation}
